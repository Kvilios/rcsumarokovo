          ...
          },
          {
            ...
            content: {
              ...
              list: [
                ...
                'Проанализировать<br>и проработать<br>возникающие проблемы.',
                ...
                'Подготовиться<br>к возвращению<br>в социальную среду.',
                'Трудоустроиться.'
              ]
            },
            icon: 'icon-3.png',
              ...
              groups: [
                {
                  ...
                  list: [
                    ...
                    'Консультирует<br>священник.',
                    'Каждая группа<br>посвящена<br>какой-либо теме.',
                    'По средам в 18:00<br>по адресу:<br>Кадыевский пер., 2.'
                  ],
                ...
                },
                {
                  ...
                  list: [
                    ...
                    'По воскресеньям в 19:00<br>skype: maksim221077.'
                  ],
